...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($validator->validateRequest($formData)) {
        $requestModel->update($id, $formData);
...
<body>
    <div class="container">
        <header>
            ...
            <div>
                <a href="view.php?id=<?= $request['id'] ?>" class="btn btn-secondary">← Back to Details</a>
        ...
        <form method="POST" class="request-form">
            ...
            <div class="form-actions">
                ...
                <a href="view.php?id=<?= $request['id'] ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</body>
